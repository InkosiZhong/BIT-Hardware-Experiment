...
#
# Generated by Vivado on Sun Aug 28 11:29:09 +0800 2022
...
# Script info
echo -e "data_buf.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot data_buf xil_defaultlib.data_buf xil_defaultlib.glbl -log elaborate.log
}
